...
void V4RCamNode::updateDynamicReconfigureFile(const char* filename) const
{
    ...
    fprintf(configfile, "gen.add(\"generate_dynamic_reconfigure\", bool_t, 0, \"Generates the dynamic reconfigure file\", False)\n");
    fprintf(configfile, "gen.add(\"dynamic_reconfigure_file\", str_t, 0, \"File to generate for the dynamic reconfigure\", \"cfg/CameraParameters.cfg\")\n");
